...
# Outlier analysis - Keep ppl who hit the ball more than 50% of the time. Exclude participants who hit the ball 50% or less of the time
...
# Linear Mixed Model (Repeated Measures ANOVA): x1 = Wall Orientation, x2 = Sound, y = Points Given 
# Recode Variables
